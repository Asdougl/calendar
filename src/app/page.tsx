...
export default async function IndexPage() {
  ...
  return (
    <main className="relative">
      <header className="sticky top-0 border-b border-neutral-800 bg-neutral-950">
      ...
      <div className="container mx-auto px-4 pt-6 lg:pt-16">
        <div className="grid md:grid-cols-2">
          <div className="flex flex-col gap-8 pb-8 md:pr-12">
            ...
            <section className="text-lg text-neutral-400">
              <p>
                <span className="font-mono text-base text-neutral-50">
                  asdougl/calendar
                </span>{' '}
